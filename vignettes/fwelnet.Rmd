...
For a new observation $\begin{pmatrix} x_1' & \dots & x_p'\end{pmatrix}$, the fwelnet prediction at $\lambda_i$ would be $\hat{\beta}_0(\lambda_i) + \sum_{j=1}^p x_j' \hat{\beta}_j (\lambda_i)$. For more details, see our paper on arXiv (to come soon).
