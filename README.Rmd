...
This repository is a fork of the original `fwelnet` implementation by Tay et al.  
...
THis version of `fwelnet` supports targets of the form `Surv(time, event)` from the `survival` package, and fits `fwelnet` through the minimization of the Cox deviance.
